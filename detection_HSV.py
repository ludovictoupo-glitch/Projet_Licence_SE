...
picam2.set_controls({"AeEnable": False, "ExposureTime": 16000, "AnalogueGain": 1.0, "AwbEnable": False, "ColourGains": (1.4, 1.45)})
time.sleep(1)
...
# CONVERSION HSV
# IMPORTANT :frame traité comme BGR ici
...
# texte HSV
texte = f"HSV : {moyenne}"
cv2.putText(image_affichage,texte,(20, 40),cv2.FONT_HERSHEY_SIMPLEX, 0.8,(0, 255, 0), 2)
